...
export class AddPermissions1745071346931 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`ressource\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
    );
    await queryRunner.query(
      `CREATE TABLE \`permission\` (\`id\` int NOT NULL AUTO_INCREMENT, \`create\` tinyint NOT NULL, \`read\` tinyint NOT NULL, \`update\` tinyint NOT NULL, \`delete\` tinyint NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, \`ressourceId\` int NULL, \`teamId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
    );
    await queryRunner.query(
      `CREATE TABLE \`team\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
    );
    await queryRunner.query(
      `CREATE TABLE \`user_teams_team\` (\`userId\` int NOT NULL, \`teamId\` int NOT NULL, INDEX \`IDX_5b1d47a221406321be714a8186\` (\`userId\`), INDEX \`IDX_a80f8ae0d425218dbaa2240df4\` (\`teamId\`), PRIMARY KEY (\`userId\`, \`teamId\`)) ENGINE=InnoDB`
    );

    // Add teams
    await queryRunner.query(
      `INSERT INTO \`team\` (\`id\`, \`name\`) VALUES (1, 'Admin'), (2, 'Event'), (3, 'Sponsorship'), (4, 'Communication'), (5, 'Adoption'), (6, 'Diffusion Manager'), (7, 'Diffusion'), (8, 'Veterinary'), (9, 'Pickup Manager'), (10, 'Pickup')`
    );

    // Add ressources
    await queryRunner.query(
      `INSERT INTO \`ressource\` (\`id\`, \`name\`) VALUES (1, 'pet_list'), (2, 'pet_info'), (3, 'pet_pickup'), (4, 'pet_health'), (5, 'pet_behavior'), (6, 'pet_diffusion'), (7, 'pet_exit'), (8, 'pet_death'), (9, 'pet_hist_veto'), (10, 'pet_hist_hf'), (11, 'hf_list'), (12, 'hf_contact'), (13, 'hf_address'), (14, 'hf_host'), (15, 'hf_hist_pets'), (16, 'vet_list'), (17, 'vet_info')`
    );

    // Add permissions
    await queryRunner.query(
      `INSERT INTO \`permission\` (\`id\`, \`teamId\`, \`ressourceId\`, \`create\`, \`read\`, \`update\`, \`delete\`) VALUES (1, 1, 1, 1, 1, 1, 1), (2, 1, 2, 1, 1, 1, 1), (3, 1, 3, 1, 1, 1, 1), (4, 1, 4, 1, 1, 1, 1), (5, 1, 5, 1, 1, 1, 1), (6, 1, 6, 1, 1, 1, 1), (7, 1, 7, 1, 1, 1, 1), (8, 1, 8, 1, 1, 1, 1), (9, 1, 9, 1, 1, 1, 1), (10, 1, 10, 1, 1, 1, 1), (11, 1, 11, 1, 1, 1, 1), (12, 1, 12, 1, 1, 1, 1), (13, 1, 13, 1, 1, 1, 1), (14, 1, 14, 1, 1, 1, 1), (15, 1, 15, 1, 1, 1, 1), (16, 1, 16, 1, 1, 1, 1), (17, 1, 17, 1, 1, 1, 1)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`animal_host_family\` DROP FOREIGN KEY \`FK_58f36bdb0c809bb6c7d768e3bf8\``
    );
    await queryRunner.query(
      `ALTER TABLE \`animal_host_family\` DROP FOREIGN KEY \`FK_cd86b3b3afe38019ac72cc9c2d8\``
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`host_family\` CHANGE \`canIsolate\` \`canIsolate\` varchar(255) NULL DEFAULT NULL`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`animal_host_family\` ADD CONSTRAINT \`FK_928e04452e2616832331ea18ff5\` FOREIGN KEY (\`animalId\`) REFERENCES \`animal\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE \`animal_host_family\` ADD CONSTRAINT \`FK_9d333a1256ad1c9bcc1d841c649\` FOREIGN KEY (\`hostFamilyId\`) REFERENCES \`host_family\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE \`permission\` ADD CONSTRAINT \`FK_72e510981244e349a56e4bac1aa\` FOREIGN KEY (\`ressourceId\`) REFERENCES \`ressource\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`user_teams_team\` ADD CONSTRAINT \`FK_5b1d47a221406321be714a8186d\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE \`user_teams_team\` ADD CONSTRAINT \`FK_a80f8ae0d425218dbaa2240df49\` FOREIGN KEY (\`teamId\`) REFERENCES \`team\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`user_teams_team\` DROP FOREIGN KEY \`FK_a80f8ae0d425218dbaa2240df49\``
    );
    await queryRunner.query(
      `ALTER TABLE \`user_teams_team\` DROP FOREIGN KEY \`FK_5b1d47a221406321be714a8186d\``
    );
    await queryRunner.query(
      `ALTER TABLE \`permission\` DROP FOREIGN KEY \`FK_4ff15ccf9e648f5255bd9f71a01\``
    );
    await queryRunner.query(
      `ALTER TABLE \`permission\` DROP FOREIGN KEY \`FK_72e510981244e349a56e4bac1aa\``
    );
    await queryRunner.query(
      `ALTER TABLE \`animal_host_family\` DROP FOREIGN KEY \`FK_9d333a1256ad1c9bcc1d841c649\``
    );
    await queryRunner.query(
      `ALTER TABLE \`animal_host_family\` DROP FOREIGN KEY \`FK_928e04452e2616832331ea18ff5\``
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`host_family\` CHANGE \`canIsolate\` \`canIsolate\` varchar(255) NULL`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_a80f8ae0d425218dbaa2240df4\` ON \`user_teams_team\``
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_5b1d47a221406321be714a8186\` ON \`user_teams_team\``
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`animal_host_family\` ADD CONSTRAINT \`FK_cd86b3b3afe38019ac72cc9c2d8\` FOREIGN KEY (\`hostFamilyId\`) REFERENCES \`host_family\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE \`animal_host_family\` ADD CONSTRAINT \`FK_58f36bdb0c809bb6c7d768e3bf8\` FOREIGN KEY (\`animalId\`) REFERENCES \`animal\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
}
