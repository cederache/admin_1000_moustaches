...
--
-- Host: localhost    Database: moustaches
-- ------------------------------------------------------
...
CREATE TABLE `Animals` (
  ...
  `health_issues` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `behaviour` varchar(255) DEFAULT NULL,
  `adopted` tinyint(1) DEFAULT NULL,
  `broadcastable` tinyint(1) DEFAULT NULL,
  ...
  `transfer_certificate` tinyint(1) DEFAULT NULL,
  `need_icad_duplicate` enum('no','waiting','received') DEFAULT NULL,
  `contract_sent` tinyint(1) DEFAULT NULL,
  `album_created` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `Animals` VALUES (1,'Sélina',1,'1982 198219 82','2012-10-20','2022-10-05 00:00:00','chat craintif','Trouvée dehors','nantes','info',NULL,NULL,NULL,NULL,NULL,'female','Tabby',1,NULL,NULL,0,0,NULL,NULL,NULL,1,0,0,NULL,NULL,1,0,'waiting',0,1),(2,'Dakota',2,NULL,NULL,'2022-10-05 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'male',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'Oswald',1,NULL,NULL,'2022-10-04 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'Niskai',1,NULL,NULL,'2023-04-11 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'female',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,'test',1,NULL,'2023-05-26','2023-05-10 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `AnimalsToHostFamilies` VALUES (1,1,'2022-09-21'),(6,1,'2023-05-11');
...
CREATE TABLE `HostFamilies` (
  ...
  `has_vehicule` tinyint(1) DEFAULT NULL,
  `can_isolate` enum('no','yes_short','yes_long') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `HostFamilies` VALUES (1,'Derache','Cédric','06644793','cedric.derache@hotmail.fr','Cédric Derache',1,NULL,NULL,'',NULL,NULL,NULL,0,'',NULL,'4 allée Maudy Piot 44200 Nantes',47.1928921,-1.5367827,NULL,0,0,2,1,NULL,'yes_long',NULL),(7,'Martin','Jacques',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,NULL,0,NULL,NULL,''),(8,'Seguin','Gaëtane',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,0,NULL,NULL,NULL),(9,'test','Test',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,0,NULL,NULL,NULL);
...
INSERT INTO `HostFamilyKinds` VALUES (1,'Chats'),(2,'Chatons + Maman'),(3,'Chiens'),(4,'Chatons biberonnage'),(5,'Chiots'),(6,'Lapins'),(13,'Chatons'),(14,'Rats'),(15,'Hamsters');
...
INSERT INTO `HostFamilyToHostFamilyKinds` VALUES (8,2),(1,2),(1,1),(1,13);
...
-- Dump completed on 2024-05-19 17:46:53
