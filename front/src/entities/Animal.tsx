...
class Animal {
    ...
    constructor(
        ...
        this.death_date = death_date?.substring(0, 10);
        this.death_reason = death_reason;
        this.sterilised = sterilised;
        this.first_vaccination_date = first_vaccination_date?.substring(0, 10);
        this.second_vaccination_date = second_vaccination_date?.substring(
            0,
            10
        );
        ...
        this.anti_parasitic_date = anti_parasitic_date?.substring(0, 10);
