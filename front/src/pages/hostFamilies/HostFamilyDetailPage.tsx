                                    ...
                                    {animalsToHostFamily.map(
                                        (animalToHostFamily, index) => (
                                            <tr>
                                                <th scope="row">
                                                    {
                                                        "animal_name" //TODO: animalToHostFamily.animal_name
                                                    }
                                                </th>
                                                <td>
                                                    {
                                                        "host_entry_date" //TODO: animalToHostFamily.host_entry_date_object.readable
                                                    }
                                                </td>
                                                <td>
                                                    {
                                                        "host_exit_date" //TODO: animalToHostFamily.host_exit_date_object.readable
                                                    }
                                                </td>
                                                <td>
                                                    <Button
